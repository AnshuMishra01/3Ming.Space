  ...
  return (
    <div>
      ...
      <div>
        ...
        <h3 className='jt__text text-xl text-green-500 text-bold md:text-4xl text-center md:mx-20 md:pr-20 mt-10 about'>"Unlock the power of Web3 streaming - Anywhere, Anytime"</h3><br></br><br></br>
